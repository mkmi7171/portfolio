...
const Projects = () => {
        ...
        return (
            <Link to={{
                ...
                <motion.div
                    ...
                    className="relative h-28 w-28 sm:h-32 sm:w-32 md:h-40 md:w-40 lg:w-48 lg:h-48  rounded-full overflow-hidden"
                    style={{
                        borderRadius: '50%'
                    }}
                >
                ...
                <div className="h-28 w-28 sm:h-32 sm:w-32 md:h-40 md:w-40 lg:w-48 lg:h-48 flex rounded-full border border-gray-400 border-opacity-50 justify-center items-center relative">
                    <div className={`absolute group-hover:rotate-90 transition-transform duration-300 h-28 w-28 sm:h-32 sm:w-32 md:h-40 md:w-40 lg:w-48 lg:h-48 rounded-full before:w-[2.5px] before:h-[2.5px] ${isDarkMode ? 'before:bg-white' : 'before:bg-black'} before:absolute before:left-[3px] before:top-2/3 before:rounded-full after:h-[2.5px] after:w-[2.5px] ${isDarkMode ? 'after:bg-white' : 'after:bg-black'} after:absolute after:right-[3px] after:top-1/3 after:rounded-full`}>
                    </div>
    ...
    return (
        <div ref={targetRef} className="relative h-[300vh]">
            <div ref={containerRef} className="sticky h-screen top-0 flex flex-col overflow-hidden justify-evenly">
                ...
                <motion.div initial={animate ? { x: "-200px" } : { x: '0' }} 
                    ...
                    <IonIcon icon={arrowBack} />
                        <p className="font-safiro-reg-i">slide to the left or right </p>

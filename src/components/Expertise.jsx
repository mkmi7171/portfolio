...
export default function Expertise() {
  ...
  return (
    <div className='flex relative flex-col item-center justify-center flex-wrap px-2 py-12 xl:px-32' style={{ perspective: '1000px' }}>
      <h2 className="text-[1rem] sm:text-[1.5rem] md:text-[2rem] xl:text-[3rem] text-center my-12 uppercase tracking-tight font-safiro-reg-i">earas of experties</h2>
      <div className='flex flex-col relative gap-24'>
        <div className='w-full flex flex-col md:flex-row md:justify-between lg:justify-evenly items-center gap-12 md:gap-5 relative' style={{ perspective: 1000 }}>
          ...
          <span className="text-[#6b47e3] font-safiro-reg border border-[#6b47e3] rounded-xl p-1 m-1">React.js</span> 
          <span className="text-[#6b47e3] font-safiro-reg border border-[#6b47e3] rounded-xl p-1 m-1">Next.js</span> 
            <h3 className='text-xl sm:text-2xl uppercase leading-relaxed font-safiro-reg-i number mt-3'>Frontend Development</h3>
            <p className='my-5 text-base sm:text-lg'>I design and build responsive, high-performance web apps using React.js, Next.js, Node.js, and TypeScript. I focus on clean, reusable, and scalable code, ensuring accessibility, optimized performance, compatibility, and strong data security</p>
        ...
        <div className='w-full flex flex-col md:flex-row-reverse md:justify-evenly gap-5 relative items-center md:items-start' style={{perspective:1000}}>
          ...
          <div className='rounded-3xl sm:w-10/12 md:w-[43%] lg:w-2/5 xl:w-6/12 px-10 md:px-0 lg:px-4 pt-10'>
            <span className="text-[#09bc8a] font-safiro-reg border p-1 border-[#09bc8a] m-1 rounded-xl ">React Native</span> 
            <span className="text-[#09bc8a] font-safiro-reg border p-1 border-[#09bc8a] m-1 rounded-xl">Android</span> 
            <span className="text-[#09bc8a] font-safiro-reg border p-1 border-[#09bc8a] m-1 rounded-xl">iOS</span> 
            <h3 className='text-xl sm:text-2xl uppercase leading-relaxed font-safiro-reg-i mt-3'>Mobile App Development</h3>
            <p className='my-5 text-base sm:text-lg'>
            I develop high-performance mobile applications using React Native and TypeScript, delivering smooth experiences on iOS and Android. I specialize in clean architecture, reusable components, optimized performance, and following best practices for every feature.
            </p>
            <Link to='/projects' className={`cursor-pointer overflow-hidden relative group border w-28 h-8 ${isDarkMode ? 'border-gray-100' : 'border-gray-500'} flex items-center rounded-xl`}>
              <div className='w-28 h-6 relative overflow-hidden px-2 py-1'>
                <div className="flex items-center">

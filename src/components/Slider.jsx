...
const Slider = ({ project, positionY, animationDone }) => {
    ...
    return (
        <div
            ref={containerRef}
            className={`px-3 sm:px-5 lg:px-0 my-4 lg:my-0 lg:top-0 lg:w-[39%] lg:pt-24 xl:pt-32 lg:left-[30.5%] relative lg:absolute z-40 slider lg:h-screen pb-8 ${animationDone ? "overflow-y-scroll" : ""
                }`}
        >
            <motion.div
                // dragConstraints={{

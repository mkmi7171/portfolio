  ...
  return (
    <div className="relative h-screen overflow-hidden" style={{ backgroundColor: isDarkMode ? "#191818" : project.color }}>
      <div className="w-full flex justify-between items-start">
        ...
        <div className="flex-[1.1] lg:flex-[0.3] h-full pt-20 lg:pt-24 xl:pt-32 px-3 
        sm:px-5 lg:pr-12 z-40">
          ...
          <AnimatedWrapper duration={1} delay={0.3}>
            <div dangerouslySetInnerHTML={{ __html: project.description }} className="text-xs sm:text-sm sm:text-base xl:text-lg py-3 md:py-4 lg:py-6 xl:py-8 tracking-tight" />
          </AnimatedWrapper>
        ...
        <div className="flex-[0.9] z-40 lg:flex-[0.3] flex flex-col gap-2 lg:gap-8 h-full pt-20 lg:pt-24 xl:pt-32">
          <AnimatedWrapper duration={1} delay={0.2}>
            <div className="flex items-center">
      ...
      {animationDone && <Link to={`/projects/${nextProject?.id}`} className="w-full lg:w-auto flex justify-end px-4 relative z-40 lg:absolute lg:right-4 lg:bottom-4 sm:right-8 sm:bottom-8">
        <div
          className="h-24 w-24 sm:h-32 sm:w-32 md:h-40 md:w-40 lg:w-48 lg:h-48 xl:h-56 xl:w-56 rounded-full next-project"
          style={{
